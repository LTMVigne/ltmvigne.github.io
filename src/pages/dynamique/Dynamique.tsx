    ...
    <div id="dynamique" className="block md:flex md:flex-wrap mt-10">
      <div className="flex-1 self-center pb-8">
        ...
        <p className="indent-5 text-lg text-justify py-4">
          {`Les potentiels dynamiques, mises à jour par nos soins et explicitées de façon plus conséquente ci-dessous, sont
          ...
          finalement, le besoin d’espaces verts publiques en zone urbaine.`}
        </p>
      </div>
    </div>
  );
