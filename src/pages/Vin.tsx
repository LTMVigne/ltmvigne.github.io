    ...
    <div id="vin" className="block md:flex md:flex-wrap mt-10">
      <div className="flex-1 self-center">
        ...
        <p className="indent-5 text-lg text-justify py-4">
          {`Nous avons vu que la surface viticole lausannoise diminue dramatiquement au cours du XIXème siècle. On pourrait ainsi légitimement penser qu’une baisse de production locale s’accompagne d’une diminution de la consommation de vin au profit d’autres types de breuvages alcoolisés. Pour étudier cette hypothèse, nous nous sommes penchés sur des données extraites à partir de l’Almanach pour le commerce et l’industrie de 1832, ainsi que des indicateurs vaudois de 1880, 1881 et 1886, 1895 et 1898.`}
        </p>
        ...
        <ul className="text-justify text-lg list-disc ml-20">
          <li>{`le nombre de commerçants pour l’ensemble de ces types d’industries, hormis les tonneliers, s’est multiplié. Ceci est dû à l’explosion démographique que connaît Lausanne au cours du XIXème siècle.`}</li>
          <li>{`il est intéressant de se pencher sur l’analyse du nombre de tonneliers puisqu’un nombre important des tonneaux fabriqués pourrait être utilisé pour stocker le vin produit localement. On observe ici que le nombre de tonneliers reste plus ou moins constant entre le début et la fin du XIXème siècle, tandis que la demande en boissons alcoolisées, illustrée par le nombre de marchands de vins et le nombre de cafés, s’accroît. Ainsi, le fait que le nombre de tonneliers n’augmente pas laisse à supposer que les produits vendus par les marchands sont majoritairement importés depuis l’étranger.`}</li>
          <li>{`le nombre de cafés explose: ces derniers proposent notamment des vins, des bières et des spiritueux`}</li>
          <li>
            {`la bière ne semble pas faire particulièrement beaucoup de concurrence au vin si l’on se repose uniquement sur la comparaison du nombre de brasseries et de marchands de vins.`}
          </li>
        </ul>
